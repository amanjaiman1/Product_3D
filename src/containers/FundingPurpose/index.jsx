  ...
  return (
    <div className="w-full h-[300vh]">
      <div className="heading ml-10">
        ...
        <p className="text-pink-100 leading-loose text-xl">
      ...
      <div className="ml-10">
        <div className="flex justify-center items-center mt-10">
          <img src={avail} alt="" className="mt-10 w-[80%]" />
        </div>

        <p className="text-pink-100 leading-loose text-xl mt-10">
        ...
        <div className="flex justify-center items-center mt-10">
          <img src={money} alt="" className="w-[80%] h-[20%] " />
        </div>
      </div>
    </div>
  );
