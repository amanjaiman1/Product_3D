...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <header className="bg-white bg-opacity-50 w-[120%] h-[60px] max-lg:hidden shadow-lg rounded-xl flex justify-between items-center">
        <div href="" className="flex-shrink-0 align-items items-center mt-1">
          <img
            className=""
            src={logo}
            alt=""
        ...
        <div className="font-medium lg:text-sm flex">
          <ul className="flex justify-around items-center ml-auto space-x-10 pr-5">
            <Link
              to="/"
