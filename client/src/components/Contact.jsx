...
function Contact() {
  ...
  return (
    <div className="contact-container">
      <h1 className="  text-center text-very-dark-desaturated-blue text-3xl leading-8 font-bold text-shadow-md mb-3 mt-3  ">Our Valuable Contributors</h1>
      ...
      <div className="pagination">
        {contributors.length > 0 && (
          <ul className="flex justify-center space-x-4 mt--10 mb-9">
            {Array.from({ length: Math.ceil(contributors.length / usersPerPage) }, (_, index) => (
              <li
                key={index}
