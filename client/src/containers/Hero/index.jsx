  ...
  return (
    <div className="h-screen flex justify-center items-center flex-wrap-reverse">
      <div className="flex-1">
        <span className="text-primary bg-hero-badge-bg text-opacity-90 font-semibold p-2 rounded max-[600px]:flex max-[600px]:justify-center">
        ...
        <div className="py-3">
          ...
          <p className="text-secondry font-normal pt-3 leading-loose max-[600px]:text-center">
