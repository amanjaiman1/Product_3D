  ...
  return (
    ...
    >
      <div className="pl-5 wrapper">
        ...
        <h1 className="ot-letter-bottom ml-3"><span data-letter="3D Tshirt Designer">3D Tshirt Designer</span></h1>
      </div>
      <div className="menu ml-auto max-md:hidden space-x-10 pr-5">
        <Link
          to="/"
        ...
        <button className="tryfree-btn justify-center p-2 rounded-md">
          Try Free
        </button>
      </div>
