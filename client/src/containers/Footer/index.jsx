...
function Footer() {
  const renderFooterLinks = () => {
    return footerLinks.map((footerLink) => (
      ...
      >
        <h4 className="font-poppins font-medium text-[18px] leading-[27px] text-[#090F4E] text-center md:text-left">
          {footerLink.title}
        </h4>
        ...
        <ul className="list-none mt-4">
          {footerLink.links.map((link, index) => (
            <li
              key={link.name}
              className={`font-poppins font-normal text-[16px] leading-[24px] text-[#63657E] hover:text-[#6058f2] cursor-pointer text-center md:text-left ${
  ...
  return (
    <footer className={`${styles.flexCenter} ${styles.paddingY} flex-col pb-25 pt-0`}>
      <div className="container mx-auto mb-5">
        <div className={`${styles.flexStart} md:flex-row flex-col mb-2 w-full flex flex-wrap justify-center md:justify-between`}>
          {/* img */}
          <motion.div
            variants={imgAnim}
            initial="hidden"
            ...
            className="flex-1 flex flex-row justify-center md:justify-start mr-10 w-full md:w-auto mb-4 md:mb-0 md:mr-4"
            style={{
              paddingRight: "2rem",
              marginLeft: "auto",
              paddingLeft: "2rem",
          ...
          <div className="flex-1 mt-10 md:mb-10 flex justify-center
