    ...
    <div className="grid justify-center lg:mt-20">
      <div className="grid justify-center row-span-1">
        <p className="text-blue-800  md:text-4xl lg:text-6xl font-bold">
          ...
          <br />
          <span className="text-blue-950 grid justify-center">
            T-Shirt Mastery
          </span>
        </p>
      </div>
      ...
      <section className="grid md:grid-cols-2 grid-cols-1 justify-center p-4">
        ...
        <p className="text-blue-800 font-bold mt-20 lg:mt-35 md:text-xl lg:text-4xl text-center">
          ...
          <span className="text-slate-800 font-normal w-1/2 text-sm md:text-lg lg:text-xl">
            ...
            elements and techniques. By utilizing software and tools, designers
            can add depth, textures, shadows, and special effects to their
            designs, resulting in eye-catching and immersive visuals that
            enhance the overall appearance of the T-shirt.
          </span>
        </p>
      </section>
      <section className="grid md:grid-cols-2 grid-cols-1 justify-center lg:-m-10 p-4">
        <p className="text-blue-800 font-bold mt-20 md:text-xl lg:text-4xl text-center">
          ...
          <span className="text-slate-800 font-normal w-1/2 text-sm md:text-lg lg:text-xl">
            ...
            to choose from. f you have a design that you'd like to use, you can
            upload it to the design website. If you don't have a design, you can
            use one of the website's templates or create your own using the
            website's design tools. Once you've uploaded your design, you can
            customize it by adding text, images, and other elements. You can
            also change the size, color, and placement of your design. Once
            you're happy with your design, you can preview it to see how it will
            look on a t-shirt. You can view your design from different angles
            and zoom in to get a close-up look.
          </span>
        </p>
      ...
      <section className="grid md:grid-cols-2 grid-cols-1 justify-center lg:-m-10 p-4">
        ...
        <p className="text-blue-800 font-bold mt-20 md:text-xl lg:text-4xl text-center">
          ...
          <span className="text-slate-800 font-normal w-1/2 text-sm md:text-lg lg:text-xl">
            ...
            <br />
            Keep your design simple. Too much text or too many images can make
            your design look cluttered. Use high-quality images. If you're using
            images in your design, make sure they're high-quality. Low-quality
            images will look pixelated and unprofessional. Choose a font that is
            easy to read. Avoid using fonts that are too small or too difficult
            to read. Proofread your design carefully. Do share your designs on
