        ...
        <div className="grid justify-center lg:mt-20">
            ...
            <section className="grid md:grid-cols-2 grid-cols-1 justify-center p-4">
                    ...
                    <span className="text-slate-800 font-normal w-1/2 text-sm md:text-lg lg:text-xl">3D T-shirt designing refers to the process of creating visually 
                        ...
                        three-dimensional elements and techniques. By utilizing 
                        software and tools, designers can add depth, textures, 
                        shadows, and special effects to their designs, resulting 
                        in eye-catching and immersive visuals that enhance the overall
                         appearance of the T-shirt.</span></p>
            </section>
            <section className="grid md:grid-cols-2 grid-cols-1 justify-center lg:-m-10 p-4">
                    <p className="text-blue-800 font-bold mt-20 md:text-xl lg:text-4xl text-center">How to design a T-shirt?<br/>
                    <span className="text-slate-800 font-normal w-1/2 text-sm md:text-lg lg:text-xl">You need to choose a t-shirt style. There are many
                    different styles to choose from. f you have a design that you'd like to use, you can upload it to the design website. If you don't have
                     a design, you can use one of the website's templates or create your own using the website's design tools. Once you've uploaded your design,
            ...
            <section className="grid md:grid-cols-2 grid-cols-1 justify-center lg:-m-10 p-4">
                    ...
                    Use high-quality images. If you're using images in your design, make sure they're high-quality. Low-quality images will look pixelated and unprofessional.
                    Choose a font that is easy to read. Avoid using fonts that are too small or too difficult to read.
                    Proofread your design carefully.
                    Do share your designs on your favorite platforms.</span>
                    </p>
            </section>
