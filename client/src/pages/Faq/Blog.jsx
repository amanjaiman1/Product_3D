...
function Blog() {
    ...
    return (
        <div style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="sm:grid justify-center hidden">
                <div className="inline-flex font-normal text-sm">
                    <div className="w-auto h-auto border border-spacing-2 border-slate-300 shadow-lg rounded-3xl p-2 text-slate-600 m-4">ALL POSTS</div>
                    <div className="w-auto h-auto border border-spacing-2 border-slate-300 shadow-lg rounded-3xl p-2 text-slate-600 m-4">T-SHIRT DESIGN TIPS</div>
                    <div className="w-auto h-auto border border-spacing-2 border-slate-300 shadow-lg rounded-3xl p-2 text-slate-600 m-4">PRINTING TECHNIQUES</div>
                    <div className="w-auto h-auto border border-spacing-2 border-slate-300 shadow-lg rounded-3xl p-2 text-slate-600 m-4">FASHION TRENDS</div>
                </div>
            </div>
            <div className="md:inline-flex justify-center lg:m-6">
               ...
               <div className="flex flex-col md:w-2/4">
                ...
                <p className="text-slate-800 font-light text-xs lg:text-lg m-4">Discover the essential tips and techniques you need to master the art of creating
                     eye-catching T-shirt designs. From color selection to typography, 
                     this article provides expert guidance to help you craft stunning designs 
            ...
            <div >
                <p className="text-blue-900 font-extrabold text-lg lg:text-4xl m-4 grid justify-center">Our Articles</p>
      ...
      <p  className={`font-poppins font-normal text-center text-[12px] leading-[27px] text-[#63657E] mx-auto mb-4`}>
